        ...
        <div className="flex flex-col lg:flex-row gap-12 max-w-6xl mx-auto">
          ...
          <div className="lg:w-1/2">
            <form onSubmit={handleSubmit} className="space-y-6 bg-white p-8 rounded-xl shadow-lg">
              ...
              <button 
                type="submit" 
                className={`w-full ${isLoading ? 'bg-blue-400' : 'bg-blue-600 hover:bg-blue-700'} text-white font-semibold py-3 px-6 rounded-lg shadow-md transition-all duration-300 flex justify-center items-center`}
                disabled={isLoading}
              >
                {isLoading ? (
                  <>
            ...
            <div className="bg-white p-8 rounded-xl shadow-lg h-full">
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">info@brainnext.com</p>
                    <p className="text-gray-600">support@brainnext.com</p>
                  </div>
                </div>
              </div>
              ...
              <div className="mt-8">
                ...
                <div className="flex space-x-4">
                  <a href="#" className="bg-blue-100 text-blue-600 p-3 rounded-full hover:bg-blue-600 hover:text-white transition-colors">
